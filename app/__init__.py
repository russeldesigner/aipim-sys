...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL', 'sqlite:///aipim_sys.db')
    ...
    from .routes.lancamentos import lanc_bp
    from .routes.despesas    import desp_bp

    app.register_blueprint(auth_bp)
    app.register_blueprint(main_bp)
    app.register_blueprint(api_bp,  url_prefix='/api')
    app.register_blueprint(lanc_bp, url_prefix='/lancamentos')
    app.register_blueprint(desp_bp, url_prefix='/despesas')
